...
class BonitationsModel(Base):
    ...
    prefers_time_min: Mapped[datetime] = mapped_column(DateTime)
    prefers_time_max: Mapped[datetime] = mapped_column(DateTime)
    approved_time: Mapped[datetime] = mapped_column(DateTime)
    ...
    status: Mapped[BonitationStatus] = mapped_column(Enum(BonitationStatus))
    type: Mapped[BonitationType] = mapped_column(Enum(BonitationType))