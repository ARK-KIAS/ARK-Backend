...
class RaceCategoriesModel(Base):
    ...
    type: Mapped[RaceCategoryType] = mapped_column(Enum(RaceCategoryType))
    ...
    jockey_weight_min: Mapped[int] = mapped_column(Integer)
    jockey_weight_max: Mapped[int] = mapped_column(Integer)
