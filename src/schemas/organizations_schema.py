...
class OrganizationsBase(BaseModel):
    ...
    name: str = Field(..., max_length=250, description="Полное название организации")
    short_name: str = Field(..., max_length=50, description="Краткое название")
    address: str = Field(..., max_length=250, description="Юридический адрес")
    mail_address: str = Field(..., max_length=250, description="Почтовый адрес")
    ...
    email: EmailStr = Field(..., max_length=250, description="Контактный email")
